...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "smoothing_convolution",
        "sources": [
            "smoothing_convolution.pyx"
        ]
    },
    "module_name": "smoothing_convolution"
}
END: Cython Metadata */
...
#define __PYX_HAVE__smoothing_convolution
#define __PYX_HAVE_API__smoothing_convolution
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'smoothing_convolution' */
static PyObject *__pyx_f_21smoothing_convolution_apply_convolution(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "smoothing_convolution"
extern int __pyx_module_is_main_smoothing_convolution;
int __pyx_module_is_main_smoothing_convolution = 0;

/* Implementation of 'smoothing_convolution' */
...
static PyObject *__pyx_pf_21smoothing_convolution_apply_convolution(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_in_img, PyArrayObject *__pyx_v_filter_2d); /* proto */
...
static PyObject *__pyx_pw_21smoothing_convolution_1apply_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_21smoothing_convolution_apply_convolution(PyArrayObject *__pyx_v_in_img, PyArrayObject *__pyx_v_filter_2d, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("apply_convolution", 0);

  /* "smoothing_convolution.pyx":6
 * 
 * cpdef apply_convolution(np.ndarray in_img, np.ndarray filter_2d):
 *     cdef np.ndarray out_img = np.zeros((in_img.shape[0],in_img.shape[1]), dtype=np.uint8)             # <<<<<<<<<<<<<<
 *     cdef int x_img, y_img, x_filter, y_filter, img_x, img_y, x_fit, y_fit
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_in_img->dimensions[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_in_img->dimensions[1])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 6, __pyx_L1_error)
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uint8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *             pixel = 0
 */
  __pyx_t_6 = (__pyx_v_in_img->dimensions[0]);
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_x_img = __pyx_t_8;

    /* "smoothing_convolution.pyx":10
 *     cdef int pixel = 0
 *     for x_img in range(0, in_img.shape[0], 1):
 *         for y_img in range(0, in_img.shape[1], 1):             # <<<<<<<<<<<<<<
 *             pixel = 0
 ...
 */
    __pyx_t_9 = (__pyx_v_in_img->dimensions[1]);
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_y_img = __pyx_t_11;

      /* "smoothing_convolution.pyx":11
 *     for x_img in range(0, in_img.shape[0], 1):
 *         for y_img in range(0, in_img.shape[1], 1):
 *             pixel = 0             # <<<<<<<<<<<<<<
 *             for x_filter in range(-(filter_2d.shape[0]//2), (filter_2d.shape[0]//2)+1, 1):
 ...
 */
      __pyx_t_12 = (__Pyx_div_long((__pyx_v_filter_2d->dimensions[0]), 2) + 1);
      __pyx_t_13 = __pyx_t_12;
      for (__pyx_t_14 = (-__Pyx_div_long((__pyx_v_filter_2d->dimensions[0]), 2)); __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        __pyx_v_x_filter = __pyx_t_14;

        /* "smoothing_convolution.pyx":13
 *             pixel = 0
 *             for x_filter in range(-(filter_2d.shape[0]//2), (filter_2d.shape[0]//2)+1, 1):
 *                 for y_filter in range(-(filter_2d.shape[1]//2), (filter_2d.shape[1]//2)+1, 1):             # <<<<<<<<<<<<<<
 *                     img_x = x_img + x_filter
 ...
 */
        __pyx_t_15 = (__Pyx_div_long((__pyx_v_filter_2d->dimensions[1]), 2) + 1);
        __pyx_t_16 = __pyx_t_15;
        for (__pyx_t_17 = (-__Pyx_div_long((__pyx_v_filter_2d->dimensions[1]), 2)); __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
          __pyx_v_y_filter = __pyx_t_17;

          /* "smoothing_convolution.pyx":14
 *             for x_filter in range(-(filter_2d.shape[0]//2), (filter_2d.shape[0]//2)+1, 1):
 *                 for y_filter in range(-(filter_2d.shape[1]//2), (filter_2d.shape[1]//2)+1, 1):
 *                     img_x = x_img + x_filter             # <<<<<<<<<<<<<<
 *                     img_y = y_img + y_filter
 ...
 */
          __pyx_v_x_fit = (__pyx_v_x_filter + __Pyx_div_long((__pyx_v_filter_2d->dimensions[0]), 2));

          /* "smoothing_convolution.pyx":17
 *                     img_y = y_img + y_filter
 *                     x_fit = x_filter + (filter_2d.shape[0]//2)
 *                     y_fit = y_filter + (filter_2d.shape[1]//2)             # <<<<<<<<<<<<<<
 *                     if img_x < 0 or img_y < 0 or img_x >= in_img.shape[0] or img_y >= in_img.shape[1]:
 *                         continue
 */
          __pyx_v_y_fit = (__pyx_v_y_filter + __Pyx_div_long((__pyx_v_filter_2d->dimensions[1]), 2));

          /* "smoothing_convolution.pyx":18
 *                     x_fit = x_filter + (filter_2d.shape[0]//2)
 *                     y_fit = y_filter + (filter_2d.shape[1]//2)
 *                     if img_x < 0 or img_y < 0 or img_x >= in_img.shape[0] or img_y >= in_img.shape[1]:             # <<<<<<<<<<<<<<
 *                         continue
 ...
 */
          ...
          __pyx_t_19 = ((__pyx_v_img_x >= (__pyx_v_in_img->dimensions[0])) != 0);
          if (!__pyx_t_19) {
          } else {
            __pyx_t_18 = __pyx_t_19;
            goto __pyx_L12_bool_binop_done;
          }
          __pyx_t_19 = ((__pyx_v_img_y >= (__pyx_v_in_img->dimensions[1])) != 0);
          __pyx_t_18 = __pyx_t_19;
          __pyx_L12_bool_binop_done:;
          if (__pyx_t_18) {

            /* "smoothing_convolution.pyx":19
 *                     y_fit = y_filter + (filter_2d.shape[1]//2)
 *                     if img_x < 0 or img_y < 0 or img_x >= in_img.shape[0] or img_y >= in_img.shape[1]:
 *                         continue             # <<<<<<<<<<<<<<
 *                     pixel += (filter_2d[x_fit][y_fit] * in_img[img_x][img_y])
 ...
 *     return out_img
 */
          __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_pixel); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_v_filter_2d), __pyx_v_x_fit, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_4, __pyx_v_y_fit, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_v_in_img), __pyx_v_img_x, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_2 = __Pyx_GetItemInt(__pyx_t_4, __pyx_v_img_y, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_4 = PyNumber_Multiply(__pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_2 = PyNumber_InPlaceAdd(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_20 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_20 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_v_pixel = __pyx_t_20;
          __pyx_L9_continue:;
        }
      }

      /* "smoothing_convolution.pyx":21
 *                         continue
 *                     pixel += (filter_2d[x_fit][y_fit] * in_img[img_x][img_y])
 *             out_img[x_img][y_img] = pixel             # <<<<<<<<<<<<<<
 *     return out_img
 */
      __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_pixel); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = __Pyx_GetItemInt(((PyObject *)__pyx_v_out_img), __pyx_v_x_img, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 21, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if (unlikely(__Pyx_SetItemInt(__pyx_t_4, __pyx_v_y_img, __pyx_t_2, int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 21, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    }
  }

  /* "smoothing_convolution.pyx":22
 *                     pixel += (filter_2d[x_fit][y_fit] * in_img[img_x][img_y])
 *             out_img[x_img][y_img] = pixel
 *     return out_img             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("smoothing_convolution.apply_convolution", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_21smoothing_convolution_1apply_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_21smoothing_convolution_1apply_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_in_img = 0;
  PyArrayObject *__pyx_v_filter_2d = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("apply_convolution (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_filter_2d)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("apply_convolution", 1, 2, 2, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "apply_convolution") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_in_img = ((PyArrayObject *)values[0]);
    __pyx_v_filter_2d = ((PyArrayObject *)values[1]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("apply_convolution", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("smoothing_convolution.apply_convolution", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_in_img), __pyx_ptype_5numpy_ndarray, 1, "in_img", 0))) __PYX_ERR(0, 5, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_filter_2d), __pyx_ptype_5numpy_ndarray, 1, "filter_2d", 0))) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_r = __pyx_pf_21smoothing_convolution_apply_convolution(__pyx_self, __pyx_v_in_img, __pyx_v_filter_2d);
...
static PyObject *__pyx_pf_21smoothing_convolution_apply_convolution(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_in_img, PyArrayObject *__pyx_v_filter_2d) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("apply_convolution", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_21smoothing_convolution_apply_convolution(__pyx_v_in_img, __pyx_v_filter_2d, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"apply_convolution", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21smoothing_convolution_1apply_convolution, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_smoothing_convolution(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_smoothing_convolution},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initsmoothing_convolution(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initsmoothing_convolution(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_smoothing_convolution(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_smoothing_convolution(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_smoothing_convolution(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'smoothing_convolution' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_smoothing_convolution(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("smoothing_convolution", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_smoothing_convolution) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "smoothing_convolution")) {
      if (unlikely(PyDict_SetItemString(modules, "smoothing_convolution", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init smoothing_convolution", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init smoothing_convolution");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
